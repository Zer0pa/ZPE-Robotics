...
Final verdict: `abandon_functional_curation`.
...
- mg_can_outcome_success_vs_failure: primary balanced accuracy 0.9220; best baseline `pca_global` 0.9298; margin -0.0078.
- mg_lift_outcome_success_vs_failure: primary balanced accuracy 0.9708; best baseline `fft_lowpass` 0.9708; margin 0.0000.
- mh_can_quality_worse_vs_better: primary balanced accuracy 0.8500; best baseline `raw_phase_aligned` 0.9000; margin -0.0500.
