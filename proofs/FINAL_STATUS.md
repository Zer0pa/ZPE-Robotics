...
| Governing blockers | `B3` fails, red-team attack `3` fails, external reproduction is open, robotics Rust ABI is not wired in |
| Current authority | `proofs/ENGINEERING_BLOCKERS.md` |
| Historical lineage | preserved under `proofs/artifacts/historical/` |

## Reading Order

1. `proofs/ENGINEERING_BLOCKERS.md`
2. `proofs/enterprise_benchmark/GATE_VERDICTS.json`
3. `proofs/red_team/red_team_report.json`
4. `proofs/runbooks/TECHNICAL_RELEASE_SURFACE.md`
5. `proofs/artifacts/historical/README.md`
