...
<sub>02 · ZPE Robotics animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>05.3 · BENCHMARKS</b><span>LEROBOT REAL DATA</span></div>
      <div>
        ...
        <div>
          <div><span>B1 compression</span><span></span><span>PASS</span></div>
          <div><span>B2 zstd baseline</span><span></span><span>PASS</span></div>
          <div><span>Replay + search</span><span></span><span>OPEN</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE &middot; LEROBOT BYTES PER FRAME</b></div>
      <div>
        <div>
          <div><span>ZPE-Robotics</span><span></span><span>187.13&times; smaller</span></div>
          <div><span>zstd_l19</span><span></span><span>4.59&times; vs raw</span></div>
          <div><span>zstd_l3</span><span></span><span>4.44&times; vs raw</span></div>
          <div><span>raw float32</span><span></span><span>1.00&times; baseline</span></div>
        </div>
      </div>
